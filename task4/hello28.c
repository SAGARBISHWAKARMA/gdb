/*symbolic name given to numeric value command to simplify coding
 * these symbol are usally declared in he header file 
 * user space program must of course , need to inlcude the header toaccese those symbole
 * */
...
case MSG_IOCTL_FILL_BUFFER://fill character
